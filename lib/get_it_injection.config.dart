...
import 'domain/banned_country/i_banned_country_repository.dart' as _i5;
import 'domain/credit_card/i_credit_card_repository.dart' as _i7;
import 'infrastructure/banned_country/banned_country_repository.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.IBannedCountryRepository>(
        () => _i6.BannedCountryRepository());
    ...
    gh.factory<_i11.SettingsBloc>(
        () => _i11.SettingsBloc(gh<_i5.IBannedCountryRepository>()));
